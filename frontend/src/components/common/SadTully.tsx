...
// SadTully component prop types
interface SadTullyProps {
  size: number;
  id: string;
}
 ...
 * Sad Tully logo SVG
 */
const SadTully: FC<SadTullyProps> = ({ size, id }: SadTullyProps) => {
  return (
    <SvgIcon
      component={(): ReactElement => (
        ...
        >
          <g
            clipPath={`url(#clip0_sad_${id})`}
            filter={`url(#filter0_sad_${id})`}
          >
            <path
