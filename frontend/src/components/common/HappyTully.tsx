...
// HappyTully component prop types
interface HappyTullyProps {
  size: number;
  id: string;
}
 ...
 */
const HappyTully: FC<HappyTullyProps> = ({ size, id }: HappyTullyProps) => {
  return (
    <SvgIcon
